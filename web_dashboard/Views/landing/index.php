<?php
/**
 * File: src/Views/landing/index.php
                    ...
                    <div class="row gy-4">
                        <div class="col-lg-5">
                            <div class="profile d-flex align-items-center gap-3">
                                <img src="<?= url('assets/img/avatar-1.webp') ?>" alt="CEO Profile"
                                    class="profile-image">
                                <div>
            ...
            <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
                <div class="image-wrapper">
                    <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                        <img src="<?= url('assets/img/about-5.webp') ?>" alt="Business Meeting"
                            class="img-fluid main-image rounded-4">
                        <img src="<?= url('assets/img/about-2.webp') ?>" alt="Team Discussion"
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="tab-pane fade active show" id="features-tab-1">
                <div class="row">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 text-center">
                        <img src="<?= url('assets/img/features-illustration-1.webp') ?>" alt="" class="img-fluid">
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="features-tab-2">
                <div class="row">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 text-center">
                        <img src="<?= url('assets/img/features-illustration-2.webp') ?>" alt="" class="img-fluid">
                    </div>
                </div>
            </div><!-- End tab content item -->
            ...
            <div class="tab-pane fade" id="features-tab-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 text-center">
                        <img src="<?= url('assets/img/features-illustration-3.webp') ?>" alt="" class="img-fluid">
                    </div>
                </div>
            </div><!-- End tab content item -->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                ...
                <div class="feature-item text-end" data-aos="fade-right" data-aos-delay="400">
                    <div class="d-flex align-items-center justify-content-end gap-4">
                        <div class="feature-content">
                            <h3>Retina Ready</h3>
                            <p>Aenean tellus metus bibendum sed posuere ac mattis non nunc vestibulum fringilla purus
                                sit amet fermentum aenean commodo.</p>
                        </div>
                        <div class="feature-icon flex-shrink-0">
                            <i class="bi bi-eye"></i>
                        </div>
            ...
            <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                <div class="phone-mockup text-center">
                    <img src="<?= url('assets/img/phone-app-screen.webp') ?>" alt="Phone Mockup" class="img-fluid">
                </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
            ...
            <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide"><img src="<?= url('assets/img/clients/client-1.png') ?>" class="img-fluid"
                        alt=""></div>
                <div class="swiper-slide"><img src="<?= url('assets/img/clients/client-2.png') ?>" class="img-fluid"
                        alt=""></div>
                <div class="swiper-slide"><img src="<?= url('assets/img/clients/client-3.png') ?>" class="img-fluid"
                        alt=""></div>
                <div class="swiper-slide"><img src="<?= url('assets/img/clients/client-4.png') ?>" class="img-fluid"
                        alt=""></div>
                <div class="swiper-slide"><img src="<?= url('assets/img/clients/client-5.png') ?>" class="img-fluid"
                        alt=""></div>
                <div class="swiper-slide"><img src="<?= url('assets/img/clients/client-6.png') ?>" class="img-fluid"
                        alt=""></div>
                <div class="swiper-slide"><img src="<?= url('assets/img/clients/client-7.png') ?>" class="img-fluid"
                        alt=""></div>
                <div class="swiper-slide"><img src="<?= url('assets/img/clients/client-8.png') ?>" class="img-fluid"
                        alt=""></div>
            </div>
