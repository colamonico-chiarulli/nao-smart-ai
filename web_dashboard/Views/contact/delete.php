<?php
/**
 * File: src/Views/contact/delete.php
...
<div class="alert alert-warning">
    <h4>Sei sicuro di voler cancellare questo contatto?</h4>
    <p>
        <strong><?= h($contact['cognome']) ?> <?= h($contact['nome']) ?></strong><br>
        <?= h($contact['email']) ?>
    </p>

    <form method="post" action="destroy">
        <?= csrf_field() ?>
        <input type="hidden" name="idContatto" value="<?= h($contact['idContatto']) ?>">
        <a href="elenco" class="btn btn-secondary">Annulla</a>
